 ...
 *
 * @wordpress-plugin
 * Plugin Name:       Hou.la Pay for WooCommerce
 * Plugin URI:        https://hou.la/fonctionnalites/pay-links
 * Description:       Synchronize your WooCommerce products with Hou.la and sell directly from your Bio page. Accept payments via Stripe Connect with automatic order creation in WooCommerce.
 * Version:           1.0.0
